 ...
 * Handles both IAM role assumption and access key authentication.
 */
@Component
...
public class AwsClientFactory {
    ...
    /**
     * Creates an STS client for role assumption.
     * Uses default credentials from:
     * 1. Environment variables (AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY)
     * 2. ~/.aws/credentials file (default profile or AWS_PROFILE env var)
    ...
    /**
     * Creates an S3 client for the specified account and region.
     */
