    ...
    extend: {
      colors: {
        ...
        'quick-action-primary': {
          DEFAULT: 'hsl(var(--quick-action-primary))',
          foreground: 'hsl(var(--quick-action-primary-foreground))',
        },
        'quick-action-secondary': {
          DEFAULT: 'hsl(var(--quick-action-secondary))',
          foreground: 'hsl(var(--quick-action-secondary-foreground))',
        },
